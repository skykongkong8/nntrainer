...
PATCH_PATH="${GGML_SRC}"/../packagefiles/ggml/0003-Export-some-internal-methods-v3.patch
# PATCH_PATH="${GGML_SRC}"/../packagefiles/ggml/0002-Export-some-internal-methods-v2.patch
