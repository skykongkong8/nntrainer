...
TEST(nntrainer_Tensor, dot_gemm_1_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 8;
...
TEST(nntrainer_Tensor, dot_gemm_8_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 8;
...
TEST(nntrainer_Tensor, dot_gemm_16_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 16;
...
TEST(nntrainer_Tensor, dot_gemm_32_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 32;
...
TEST(nntrainer_Tensor, dot_gemm_64_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 64;
...
TEST(nntrainer_Tensor, dot_gemm_128_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 128;
...
TEST(nntrainer_Tensor, dot_gemm_256_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 256;
...
TEST(nntrainer_Tensor, dot_gemm_512_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 512;
...
TEST(nntrainer_Tensor, dot_gemm_768_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 768;
...
TEST(nntrainer_Tensor, dot_gemm_1440_1024_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 1440;
