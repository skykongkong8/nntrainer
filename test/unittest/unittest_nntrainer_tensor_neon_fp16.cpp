...
TEST(nntrainer_Tensor, dot_gemm_512_41_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 512;
    ...
    for (int c = 0; c < channel; c++) {
      for (int h = 0; h < height; h++) {
        for (int w = 0; w < width; w++) {
          double err = std::abs(C.getValue<__fp16>(b, c, h, w) -
                                C_fp32.getValue(b, c, h, w));

          if (err > eps) {
            std::cout << h << " , " << w << " | \t";
            std::cout << C.getValue<__fp16>(b, c, h, w) << " VS "
                      << C_fp32.getValue(b, c, h, w) << std::endl;
          }
        }
      }
    }
...
// TEST(nntrainer_Tensor, dot_gemm_use_1280_21_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 1280;
...
// TEST(nntrainer_Tensor, dot_gemm_use_1280_22_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 1280;
...
// TEST(nntrainer_Tensor, dot_gemm_use_784_42_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 784;
...
// TEST(nntrainer_Tensor, dot_gemm_use_1280_23_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 1280;
...
TEST(nntrainer_Tensor, dot_gemm_512_48_1024) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 1024;
...
TEST(nntrainer_Tensor, dot_gemm_1280_22_784) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 22;
...
auto dts = duration_cast<seconds>(t2 - t1);
std::cout << "fp16 : " << dt.count() / TC
        << " ns " << ", gflops : " << gflops / (dts.count() / TC) <<std::endl;
...
// TEST(nntrainer_Tensor, dot_gemm_use_1280_25_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 1280;
...
// TEST(nntrainer_Tensor, dot_gemm_use_1280_26_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 1280;
...
// TEST(nntrainer_Tensor, dot_gemm_use_1280_27_784) {
//   /// @note GEMM : A X B = C
//   int batch = 1;
//   int channel = 1;
//   int height = 1280;
