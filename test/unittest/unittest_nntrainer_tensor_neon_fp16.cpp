...
TEST(nntrainer_Tensor, dot_gemm_biqgemm1) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 1;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm2) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 8;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm3) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 16;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm4) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 32;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm5) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 64;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm6) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 128;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm7) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 256;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm8) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 512;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm9) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 568;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm10) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 768;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm11) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 1024;
...
TEST(nntrainer_Tensor, dot_gemm_biqgemm12) {
  /// @note GEMM : A X B = C
  int batch = 1;
  int channel = 1;
  int height = 1440;
