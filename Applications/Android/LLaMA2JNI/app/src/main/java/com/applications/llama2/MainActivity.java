package com.applications.llama2;
...
public class MainActivity extends AppCompatActivity {
    ...
    static {
        System.loadLibrary("llama2_jni");
    }

    public native long createLLaMA2(String path);

    public native String inferLLaMA2(String path, String sentence, long model_pointer);
	...
	if(! (new File(folder_name+"/summarization_v2_fp16.bin").exists()))
	    copyAssetFolder(getApplicationContext(), "summarization_v2_fp16.bin", folder_name+"/summarization_v2_fp16.bin");
	...
	Button infer_btn = (Button)findViewById(R.id.infer_llama2);

	model_pointer = createLLaMA2(folder_name);
	...
	infer_btn.setOnClickListener(new View.OnClickListener(){
		...
		public void onClick(View v){
		    ...
		    Thread th_run = new Thread(new Runnable(){
				...
				Infer_log+=inferLLaMA2(path, in_text.getText().toString(), model_pointer);
