...
LOCAL_C_INCLUDES += $(NNTRAINER_INCLUDES) $(LLAM2_DIR)
...
LOCAL_MODULE_TAGS := optional
LOCAL_ARM_MODE := arm
LOCAL_MODULE := llama2_jni
LOCAL_LDLIBS := -llog -landroid -fopenmp -static-openmp -DENABLE_FP16=1 -DUSE__FP16=1

LOCAL_SRC_FILES := llama2.cpp llama2_jni.cpp

LOCAL_SHARED_LIBRARIES := nntrainer ccapi-nntrainer rms_norm_layer swiglu_layer

LOCAL_C_INCLUDES += $(NNTRAINER_INCLUDES) $(LLAMA2_DIR)
