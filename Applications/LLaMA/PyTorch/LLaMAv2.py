...
state_dict = torch.load('/home/jijoongmoon/pytorch_model.bin')
...
X = [101,  2048,  2250,  2634,  8221,  2031,  2042,  3718,  2013,  4611,
...
input=torch.tensor([[1,1]], dtype=torch.long)
output=[]
