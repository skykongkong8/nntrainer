...
size_t SQ4BitGemmPackQuantBDataSize(size_t N, size_t K, size_t BlkLen,
                                    MLAS_SQNBIT_GEMM_COMPUTE_TYPE ComputeType) {
  MLAS_UNREFERENCED_PARAMETER(
    ComputeType); // same size regardless of ComputeType
...
void SQ4BitGemmPackQuantBData(size_t N, size_t K, size_t BlkLen,
                              MLAS_SQNBIT_GEMM_COMPUTE_TYPE ComputeType,
  ...
  const size_t SubBlkLen =
    (ComputeType == CompInt8) ? ((BlkLen == 16) ? 16 : 32) : 16;
...
const MLAS_SQNBIT_GEMM_DISPATCH MlasSQNBitGemmDispatchNeon = []() {
  ...
  d.SQ4BitGemmPackQuantBDataSize =
    sqnbitgemm_neon::SQ4BitGemmPackQuantBDataSize;
  d.SQ4BitGemmPackQuantBData = sqnbitgemm_neon::SQ4BitGemmPackQuantBData;

  d.SQ4BitGemmPerGemmWorkspaceSize =
    sqnbitgemm_neon::SQ4BitGemmPerGemmWorkspaceSize;
  d.SQ4BitGemmPerGemmWorkspaceAlignment =
    sqnbitgemm_neon::SQ4BitGemmPerGemmWorkspaceAlignment;
