...
std::vector<std::string> GetStackTrace() {
  ...
  // NOTE: To get meaningful info from the output, addr2line (or atos on osx)
  // would need to be used. See https://gist.github.com/jvranish/4441299 for an
  // example.
  //
  // To manually translate the output, use the value in the '()' after the
  // executable name with addr2line e.g.
  //   Stacktrace:
  //    /home/me/src/github/onnxruntime/build/Linux/Debug/onnxruntime_test_all(+0x3f46cc)
  //    [0x559543faf6cc]
  //
  // >addr2line -f -C -e
  // /home/me/src/github/onnxruntime/build/Linux/Debug/onnxruntime_test_all
  // +0x3f46cc
