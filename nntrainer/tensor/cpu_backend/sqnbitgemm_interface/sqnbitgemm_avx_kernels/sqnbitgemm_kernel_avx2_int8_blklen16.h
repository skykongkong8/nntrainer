/**
 * @file sqnbitgemm_kernel_avx2_int8_blklen16.h
...
inline __m256 load_and_broadcast_4_scale_2(const float *scale) {
  // 3 2 1 0 3 2 1 0 (7)
  ...
  __m256 scale_2_4_ps_permutted =
    _mm256_permute2f128_ps(scale_2_4_ps_shifted, scale_2_4_ps, 0b00110000);
...
inline __m256i load_16_epi8_as_epi16(const std::byte *ablob) {
  const __m128i av_epi8 =
    _mm_lddqu_si128(reinterpret_cast<const __m128i *>(ablob));
  __m256i av_epi16 = _mm256_cvtepi8_epi16(av_epi8);
  return av_epi16;
}

inline void accumulate_r1_4blk_dot(const __m256i &av0_32_epi8,
  ...
  const __m256i sum_16_inter_leaved_epi16 =
  ...
  const __m256i sum_8_inter_leaved_epi32 =
    _mm256_madd_epi16(one_16_epi16, sum_16_inter_leaved_epi16);
  const __m256 sum_8_inter_leaved_ps =
    _mm256_cvtepi32_ps(sum_8_inter_leaved_epi32);
...
inline void
accumulate_r2_4blk_dot(const __m256i &av00_32_epi8, const __m256i &av01_32_epi8,
                       const __m256i &av10_32_epi8, const __m256i &av11_32_epi8,
                       const __m256i &bv0_32_epi8, const __m256i &bv1_32_epi8,
                       const float *scale_a0, const float *scale_a1,
  ...
  const __m256i sum_16_inter_leaved_epi16_ =
    _mm256_hadd_epi16(dot0_16_epi16_, dot1_16_epi16_);
  const __m256i sum_8_inter_leaved_epi32_ =
    _mm256_madd_epi16(one_16_epi16, sum_16_inter_leaved_epi16_);
  const __m256 sum_inter_leaved_ps_ =
    _mm256_cvtepi32_ps(sum_8_inter_leaved_epi32_);
...
load_4b_packed_1blk_blklen16(const std::byte *QuantBDataPtr) {
  // | 0 8 |...| 7 15 |
  const __m128i bv_packed_64 =
    _mm_loadl_epi64(reinterpret_cast<const __m128i *>(QuantBDataPtr));
  const __m128i low_mask = _mm_set1_epi8(0xF);
  const __m128i lower_8_epu8 = _mm_and_si128(bv_packed_64, low_mask); // 0~7
  const __m128i upper_8_epu8 = _mm_bslli_si128(
    _mm_and_si128(_mm_srli_epi16(bv_packed_64, 4), low_mask), 8); // 8~15
  const __m256i bv_16_epu16 =
    _mm256_cvtepi8_epi16(_mm_add_epi8(upper_8_epu8, lower_8_epu8)); // 0~15
  return bv_16_epu16;
}

static inline void load_4b_packed_4blk_blklen16(const std::byte *QuantBDataPtr,
                                                __m256i &bv0_32_epi8,
                                                __m256i &bv1_32_epi8) {
  // | 0 8 |...| 7 15 | 16 24 |...| 23 31 ||| 32 40 |...| 39 47 | 48 56 |...| 55
  // 63 |
  ...
  __m256i bv1_32_epi8_ =
    _mm256_srli_epi16(_mm256_sub_epi8(bv_packed, bv0_32_epi8_), 4);
...
static inline void accumulate_blklen16_r2c1blk4_avx2(
  ...
  accumulate_r2_4blk_dot(av00_32_epi8, av01_32_epi8, av10_32_epi8, av11_32_epi8,
                         bv0_32_epi8, bv1_32_epi8, scale_a0, scale_a1, scale_b,
                         acc0, acc1);
}

static inline void accumulate_blklen16_r1c1blk4_avx2(
  const __m256i &av0_32_epi8, const __m256i &av1_32_epi8,
  const std::byte *QuantBDataPtr, const float *scale_a, const float *scale_b,
  __m256 &acc) {
  __m256i bv0_32_epi8, bv1_32_epi8;
  load_4b_packed_4blk_blklen16(QuantBDataPtr, bv0_32_epi8, bv1_32_epi8);
  accumulate_r1_4blk_dot(av0_32_epi8, av1_32_epi8, bv0_32_epi8, bv1_32_epi8,
                         scale_a, scale_b, acc);
}

static inline void accumulate_blklen16_r2c1blk1_avx2(
  const __m256i &av0_32_epi8, const __m256i &av1_32_epi8,
  const std::byte *QuantBDataPtr, const float &combined_scale0,
  const float &combined_scale1, __m256 &acc0, __m256 &acc1) {
...
static inline void
accumulate_blklen16_r1c1blk1_avx2(const __m256i &av_16_epi8,
...
inline void Q4Int8GemmR2xC4BlkLen16Avx2(const std::byte *QuantA,
  ...
  constexpr size_t BlkDataSizeInBytes8 =
    ...
    for (size_t n = 0; n < CountN; n += NCols4) {
      ...
      for (; k_blks_remaining > 3; k_blks_remaining -= PerAccuBlk4) {
        ...
        const __m256i av_01_epi8 =
          _mm256_loadu_si256((const __m256i *)(QuantAPtr + 32));
        const __m256i av_10_epi8 =
          _mm256_loadu_si256((const __m256i *)(QuantAPtr + lda));
        const __m256i av_11_epi8 =
          _mm256_loadu_si256((const __m256i *)(QuantAPtr + lda + 32));

        accumulate_blklen16_r2c1blk4_avx2(
          av_00_epi8, av_01_epi8, av_10_epi8, av_11_epi8, QuantBDataPtr,
          QuantAScalePtr, QuantAScalePtr + BlockCountK, QuantBScalePtr, acc[0],
          acc[NCols4]);
        accumulate_blklen16_r2c1blk4_avx2(
          av_00_epi8, av_01_epi8, av_10_epi8, av_11_epi8,
          QuantBDataPtr + StrideQuantBData, QuantAScalePtr,
          QuantAScalePtr + BlockCountK, QuantBScalePtr + StrideQuantBScale,
          acc[1], acc[NCols4 + 1]);
        accumulate_blklen16_r2c1blk4_avx2(
          av_00_epi8, av_01_epi8, av_10_epi8, av_11_epi8,
          QuantBDataPtr + 2 * StrideQuantBData, QuantAScalePtr,
          QuantAScalePtr + BlockCountK, QuantBScalePtr + 2 * StrideQuantBScale,
          acc[2], acc[NCols4 + 2]);
        accumulate_blklen16_r2c1blk4_avx2(
          av_00_epi8, av_01_epi8, av_10_epi8, av_11_epi8,
          QuantBDataPtr + 3 * StrideQuantBData, QuantAScalePtr,
          QuantAScalePtr + BlockCountK, QuantBScalePtr + 3 * StrideQuantBScale,
          acc[3], acc[NCols4 + 3]);
      ...
      while (k_blks_remaining-- > 0) {
...

        {
          ...
          accumulate_blklen16_r2c1blk1_avx2(av0_16_epi16, av1_16_epi16,
                                            QuantBDataPtr, scale_00, scale_10,
                                            acc[0], acc[NCols4]);
        }

        {
          const float scale_00 =
            scale_a00 * (QuantBScalePtr + StrideQuantBScale)[0];
          const float scale_10 =
            scale_a10 * (QuantBScalePtr + StrideQuantBScale)[0];
          accumulate_blklen16_r2c1blk1_avx2(
            av0_16_epi16, av1_16_epi16, QuantBDataPtr + StrideQuantBData,
            scale_00, scale_10, acc[1], acc[NCols4 + 1]);
        }

        {
          const float scale_00 =
            scale_a00 * (QuantBScalePtr + 2 * StrideQuantBScale)[0];
          const float scale_10 =
            scale_a10 * (QuantBScalePtr + 2 * StrideQuantBScale)[0];
          accumulate_blklen16_r2c1blk1_avx2(
            av0_16_epi16, av1_16_epi16, QuantBDataPtr + 2 * StrideQuantBData,
            scale_00, scale_10, acc[2], acc[NCols4 + 2]);
        }

        {
          const float &scale_00 =
            scale_a00 * (QuantBScalePtr + 3 * StrideQuantBScale)[0];
          const float &scale_10 =
            scale_a10 * (QuantBScalePtr + 3 * StrideQuantBScale)[0];
          accumulate_blklen16_r2c1blk1_avx2(
            av0_16_epi16, av1_16_epi16, QuantBDataPtr + 3 * StrideQuantBData,
...
void inline Q4Int8GemmR2xC1BlkLen16Avx2(const std::byte *QuantA,
                                        const float *QuantAScale,
                                        const std::byte *QuantBData,
                                        const float *QuantBScale, float *C,
                                        size_t CountM, size_t CountN,
  ...
  for (size_t m = 0; m < CountM; m += NRows2) {
    ...
    for (size_t n = 0; n < CountN; n++) {
      ...
      for (; k_blks_remaining >= PerAccuBlk4; k_blks_remaining -= PerAccuBlk4) {
        ...
        // load A:
        const __m256i av_00_epi8 =
          _mm256_loadu_si256((const __m256i *)QuantABlk00);
        const __m256i av_01_epi8 =
          _mm256_loadu_si256((const __m256i *)QuantABlk01);
        const __m256i av_10_epi8 =
          _mm256_loadu_si256((const __m256i *)QuantABlk10);
        const __m256i av_11_epi8 =
          _mm256_loadu_si256((const __m256i *)QuantABlk11);
...
inline void Q4Int8GemmR1xC4BlkLen16Avx2(const std::byte *QuantA,
                                        const float *QuantAScale,
                                        const std::byte *QuantBData,
                                        const float *QuantBScale, float *C,
                                        size_t CountM, size_t CountN,
    ...
    for (size_t n = 0; n < CountN; n += NCols4) {
      ...
      while (k_blks_remaining-- > 0) {
        ...
        const float &scale_a00 = *QuantAScalePtr;
        {
          // Col0
          const float &scale_00 = scale_a00 * (QuantBScalePtr)[0];
          accumulate_blklen16_r1c1blk1_avx2(av_00_epi8, QuantBDataPtr, scale_00,
                                            acc[0]);
        }
        {
          // Col1
          ...
          accumulate_blklen16_r1c1blk1_avx2(
            av_00_epi8, QuantBDataPtr + StrideQuantBData, scale_00, acc[1]);
        }
        {
          // Col2
          const float &scale_00 =
            scale_a00 * (QuantBScalePtr + 2 * StrideQuantBScale)[0];
          accumulate_blklen16_r1c1blk1_avx2(
            av_00_epi8, QuantBDataPtr + 2 * StrideQuantBData, scale_00, acc[2]);
        }
        {
          // Col3
          const float &scale_00 =
            scale_a00 * (QuantBScalePtr + 3 * StrideQuantBScale)[0];
          accumulate_blklen16_r1c1blk1_avx2(
            av_00_epi8, QuantBDataPtr + 3 * StrideQuantBData, scale_00, acc[3]);
        }
        QuantAPtr += BlkLen16;
        QuantAScalePtr++;
        QuantBDataPtr += BlkDataSizeInBytes8;
...
inline void Q4Int8GemmR1xC1BlkLen16Avx2(const std::byte *QuantA,
                                        const float *QuantAScale,
                                        const std::byte *QuantBData,
                                        const float *QuantBScale, float *C,
                                        size_t CountM, size_t CountN,
  ...
  for (size_t m = 0; m < CountM; m++) {
    ...
    for (size_t n = 0; n < CountN; n++) {
      ...
      while (k_blks_remaining-- > 0) {
        ...
        const float &scale_a00 = *QuantAScalePtr;
        const float &scale_00 = scale_a00 * (QuantBScalePtr)[0];
        accumulate_blklen16_r1c1blk1_avx2(av_16_epi16, QuantBDataPtr, scale_00,
                                          acc0);
...
inline size_t MlasQ4Int8GemmKernelBlkLen16Avx2(
  ...
  if (multipleRows > 0 && multipleCols > 0) {
    Q4Int8GemmR2xC4BlkLen16Avx2(QuantA, QuantAScale, QuantBData, QuantBScale, C,
                                multipleRows, multipleCols, BlockCountK, Bias,
                                ldc);
  }
