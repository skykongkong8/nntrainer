 ...
 */
bool __fallback_isValid(const size_t N, const _FP16 *X);
 ...
 */
void __fallback_compute_rotary_embedding_value(unsigned int dim, unsigned int half_,
 ...
 */
void __fallback_calc_trigonometric_vals_dup(unsigned int N_half, float *angle, float *cos_,
 ...
 * @param[out] bool false if not valide else true
 */
bool __fallback_isValid(const size_t N, const float *X);
