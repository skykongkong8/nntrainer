...
void vcvt_f16_f32(size_t N, const _Float16 *input, float *output) {
  assert(N != 0);
  assert(input != NULL);
  assert(output != NULL);
...
void vcvt_f32_f16(size_t N, const float *input, _Float16 *output) {
  assert(N != 0);
  assert(input != NULL);
  assert(output != NULL);
...
bool is_valid(const size_t N, const _Float16 *input) {
  assert(N != 0);
  assert(input != NULL);
