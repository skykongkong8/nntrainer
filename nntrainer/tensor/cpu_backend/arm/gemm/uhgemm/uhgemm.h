 ...
 * @brief  This is uint16 GEMM interface
 *
 */
#include <stdint.h>
...
void uhgemm(const uint16_t *A, const uint16_t *B, uint16_t *C, unsigned int M,
            unsigned int N, unsigned int K, unsigned int alpha,
 ...
 * @param[in] TransB bool transpose info of rhs matrix
 */
void uhgemm_pure(const uint16_t *A, const uint16_t *B, uint16_t *C,
                 unsigned int M, unsigned int N, unsigned int K,
                 unsigned int alpha, unsigned int beta, bool TransA,
                 bool TransB);
/**
 * @brief     uhgemm computation with neon but with small dim without padding :
 * Y = alpha*op(A)*op(B) + beta*C, where op(X) is one of X or X**T
 * @param[in] A uint16_t * for Matrix A
 * @param[in] B uint16_t * for Matrix B
 * @param[in] C uint16_t * for Matrix C
 * @param[in] M number of op(A)'s and C's row
 ...
 * @param[in] TransB bool transpose info of rhs matrix
 */
void uhgemm_small(const uint16_t *A, const uint16_t *B, uint16_t *C,
                  unsigned int M, unsigned int N, unsigned int K,
                  unsigned int alpha, unsigned int beta, bool TransA,
                  bool TransB);
 ...
 * @param[in] TransB bool transpose info of rhs matrix
 */
void uhgemm_ensure_divisibility(const uint16_t *A, const uint16_t *B,
                                unsigned int *C32, unsigned int M,
 ...
 */
void uhgemm_ensure_divisibility(const uint16_t *A, const uint16_t *B,
                                uint16_t *C, unsigned int M, unsigned int N,
                                unsigned int K, unsigned int alpha = 1.F,
                                unsigned int beta = 0, bool TransA = false,
                                bool TransB = false);
 ...
 * @param[in] TransB bool transpose info of rhs matrix
 */
void uhgemm_K1(const uint16_t *A, const uint16_t *B, uint16_t *C,
               unsigned int M, unsigned int N, unsigned int K,
               unsigned int alpha, unsigned int beta, bool TransA, bool TransB);
