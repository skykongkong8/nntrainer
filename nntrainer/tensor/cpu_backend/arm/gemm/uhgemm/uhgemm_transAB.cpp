 ...
 * @brief  This is uint16 GEMM interface of transposed  AB case
 *
 */
...
void uhgemm_transAB(const uint16_t *A, const uint16_t *B, unsigned int *C,
                    unsigned int M, unsigned int N, unsigned int K,
                    unsigned int alpha, unsigned int beta) {
  uint16_t *A_T = alignedMalloc<uint16_t>(M * K);
  uint16_t *B_T = alignedMalloc<uint16_t>(K * N);
...
void uhgemm_transAB(const uint16_t *A, const uint16_t *B, uint16_t *C,
                    unsigned int M, unsigned int N, unsigned int K,
                    unsigned int alpha, unsigned int beta) {
  uint16_t *A_T = alignedMalloc<uint16_t>(M * K);
  uint16_t *B_T = alignedMalloc<uint16_t>(K * N);
