 ...
 *
 * @file   uhgemm_kernel_8x16.cpp
 * @date   04 August 2024
 * @see    https://github.com/nnstreamer/nntrainer
 * @author Sungsik Kong <ss.kong@samsung.com>
 * @bug    No known bugs except for NYI items
 * @brief  This is uint16 GEMM 8x16 kernel
 *
 */
...
void uhgemm_kernel_8x16(unsigned int M, unsigned int N, unsigned int K,
  ...
  for (i = 0; i < M; i += 8) {
    for (j = 0; j < N; j += 16) {
      ...
      vst1q_u16(c, vaddq_u16(vld1q_u16(c), v0_7));
      vst1q_u16(c + 8, vaddq_u16(vld1q_u16(c + 8), v64_71));
      vst1q_u16(c + ldc, vaddq_u16(vld1q_u16(c + ldc), v8_15));
      vst1q_u16(c + ldc + 8, vaddq_u16(vld1q_u16(c + ldc + 8), v72_79));
      vst1q_u16(c + 2 * ldc, vaddq_u16(vld1q_u16(c + 2 * ldc), v16_23));
      vst1q_u16(c + 2 * ldc + 8, vaddq_u16(vld1q_u16(c + 2 * ldc + 8), v80_87));
      vst1q_u16(c + 3 * ldc, vaddq_u16(vld1q_u16(c + 3 * ldc), v24_31));
      vst1q_u16(c + 3 * ldc + 8, vaddq_u16(vld1q_u16(c + 3 * ldc + 8), v88_95));
      vst1q_u16(c + 4 * ldc, vaddq_u16(vld1q_u16(c + 4 * ldc), v32_39));
      vst1q_u16(c + 4 * ldc + 8,
                vaddq_u16(vld1q_u16(c + 4 * ldc + 8), v96_103));
      vst1q_u16(c + 5 * ldc, vaddq_u16(vld1q_u16(c + 5 * ldc), v40_47));
      vst1q_u16(c + 5 * ldc + 8,
                vaddq_u16(vld1q_u16(c + 5 * ldc + 8), v104_111));
      vst1q_u16(c + 6 * ldc, vaddq_u16(vld1q_u16(c + 6 * ldc), v48_55));
      vst1q_u16(c + 6 * ldc + 8,
                vaddq_u16(vld1q_u16(c + 6 * ldc + 8), v112_119));
      vst1q_u16(c + 7 * ldc, vaddq_u16(vld1q_u16(c + 7 * ldc), v56_63));
      vst1q_u16(c + 7 * ldc + 8,
                vaddq_u16(vld1q_u16(c + 7 * ldc + 8), v120_127));
      c += 16;
      a -= 8 * K;
    }
    sc += ldc * 8;
