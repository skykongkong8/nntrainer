...
void hgemmv9(unsigned int M, unsigned int N, unsigned int K, float alpha,
  ...
  __fp16 *b_buffer = (__fp16 *)aligned_alloc(4096, K_BLOCKING * N_BLOCKING * sizeof(__fp16));
  __fp16 *a_buffer = (__fp16 *)aligned_alloc(4096, K_BLOCKING * M_BLOCKING * sizeof(__fp16));
