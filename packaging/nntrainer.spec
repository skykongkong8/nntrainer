...
%{_includedir}/nntrainer/mlas_qnbit.h
%{_includedir}/nntrainer/mlas.h
%{_includedir}/nntrainer/mlasi.h
%{_includedir}/nntrainer/q4common.h
%{_includedir}/nntrainer/sqnbitgemm_q8_block.h
%{_includedir}/nntrainer/sqnbitgemm.h
%{_includedir}/nntrainer/test_util.h
%{_includedir}/nntrainer/mlas_float16.h
%{_includedir}/nntrainer/qgemm.h
...
%{_includedir}/nntrainer/env.h
%{_includedir}/nntrainer/ort_mutex.h
%{_includedir}/nntrainer/ort_spin_lock.h
%{_includedir}/nntrainer/threadpool.h
%{_includedir}/nntrainer/tracing.h
%{_includedir}/nntrainer/callback.h
%{_includedir}/nntrainer/endian.h
%{_includedir}/nntrainer/float16.h
%{_includedir}/nntrainer/basic_types.h
%{_includedir}/nntrainer/code_location.h
%{_includedir}/nntrainer/common.h
%{_includedir}/nntrainer/const_pointer_container.h
%{_includedir}/nntrainer/cpuid_arch_definition.h
%{_includedir}/nntrainer/cpuid_info.h
%{_includedir}/nntrainer/cpuid_uarch.h
%{_includedir}/nntrainer/denormal.h
%{_includedir}/nntrainer/exceptions.h
%{_includedir}/nntrainer/hash_combine.h
%{_includedir}/nntrainer/make_string.h
%{_includedir}/nntrainer/optional.h
%{_includedir}/nntrainer/parse_string.h
%{_includedir}/nntrainer/path_string.h
%{_includedir}/nntrainer/profiler_common.h
%{_includedir}/nntrainer/span_utils.h
%{_includedir}/nntrainer/spin_pause.h
%{_includedir}/nntrainer/status.h
%{_includedir}/nntrainer/string_helper.h
%{_includedir}/nntrainer/capture.h
%{_includedir}/nntrainer/isink.h
%{_includedir}/nntrainer/logging.h
...
%{_includedir}/nntrainer/sqnbitgemm_kernel_avx_common.h
%{_includedir}/nntrainer/sqnbitgemm_kernel_avx2_int8_blklen16.h
%{_includedir}/nntrainer/sqnbitgemm_kernel_avx2_int8_blklen32.h
%{_includedir}/nntrainer/sqnbitgemm_kernel_avx2_int8_blklen64.h
%endif
%ifarch aarch64
